...
def run_code(mem):
    ...
    while True:
        ...
        if opcode == 1:
            ...
            # Input
            #val1 = get_param_value(mem, param1, mode_c, relative_base)
            set_mem_value(mem, param1, mode_c, relative_base, input_value)
            ...
            val1 = get_param_value(mem, param1, mode_c, relative_base)
            # print("");
            # print("Adjusts relative_base DEBUG param1 {} mode {} relative_base {}".format(param1, mode_c, relative_base))
            relative_base += val1
